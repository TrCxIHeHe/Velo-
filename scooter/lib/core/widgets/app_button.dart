...
/// Button/primary — brand-filled, radius 12, 15/semibold label.
...
/// Button/outline — bordered, text/primary label.
...
/// Button/danger-outline — bordered in error color, e.g. Log out.
...
/// Button/text — no fill, brand-colored label (e.g. Resend OTP).
